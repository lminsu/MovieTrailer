...
- [open class와 interface(상속과 구현)](https://github.com/lminsu/MovieTrailer/issues/24#issuecomment-2512260228)
## 안드로이드 개념 정리
...
- [안드로이드4대 컴포넌트](https://github.com/lminsu/MovieTrailer/issues/29)
## 크래시 디버깅 경험
